                    ...
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="95%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td align="left" valign="top"><font style="font-family: Verdana, Geneva, sans-serif; color:#000000; font-size:13px; line-height:21px">Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio t non</font> <font style="font-family:Verdana, Geneva, sans-serif; color:#000000; font-size:12px; line-height:20px"><a href= "http://yourlink" style="color:#000000; text-decoration:none"><strong><em>read more} </em></strong></a></font></td>
                          </tr>
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                          ...
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td width="57%" align="left" valign="top"><font style="font-family: Georgia, 'Times New Roman', Times, serif; color:#000000; font-size:20px"><strong><em>Second feature</em></strong></font> <br />
                                  <font style="font-family: Verdana, Geneva, sans-serif; color:#000000; font-size:13px; line-height:21px">Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quisn</font> <font style="font-family:Verdana, Geneva, sans-serif; color:#000000; font-size:12px; line-height:20px"><a href= "http://yourlink" style="color:#000000; text-decoration:none"><strong><em>read more} </em></strong></a></font><font style="font-family: Verdana, Geneva, sans-serif; color:#000000; font-size:13px; line-height:21px">&nbsp; </font></td>
                              </tr>
                            </table></td>
                          </tr>
                          <tr>
                        ...
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="12%">&nbsp;</td>
                                <td width="79%" bgcolor="#e4e4e4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="5%"></td>
                                  ...
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td align="center"><font style="font-family: Georgia, 'Times New Roman', Times, serif; color:#000102; font-size:16px"><strong>SPECIAL
                                  ...
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td align="left" valign="top"><font style="font-family: Georgia, 'Times New Roman', Times, serif; color:#010000; font-size:14px; line-height:21px">Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, <font style="font-family:Verdana, Geneva, sans-serif; color:#000000; font-size:12px; line-height:20px"><a href= "http://yourlink" style="color:#000000; text-decoration:none"><strong><em>read more} </em></strong></a></font></font></td>
                                    <td>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
